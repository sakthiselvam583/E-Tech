...
export default class StudentTutorail   extends Component  {
   ...
   async componentDidMount()
    {
        ...
        let tableData = await CmsContent.getFreedom(
            ...
            `tbl_boxcontent.catagory_id=121 and  tbl_map_grouptoportlet.customerId=${customerid} and tbl_boxcontent.grade=${grade} and  tbl_boxcontent.name=tbl_map_grouptoportlet.contentid `,
            "id",
            "id DESC"
          )
